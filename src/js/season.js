...
function getSeason() {
  ...
  // Estações do Hemisfério Norte (Ásia, Europa, América do Norte)
...
function runSeason(season) {
  ...
  const seasons = {
    ...
    winterSeason: {
      ...
      backgroundh1: "#73482F",
      backgroundh2:
        "linear-gradient(180deg, rgba(2,72,115,1) 0%, rgba(3,101,140,1) 57%, rgba(2,72,115,0.8911939775910365) 92%)",
      backgroundp:
        "linear-gradient(180deg, rgba(2,72,115,0.7595413165266106) 0%, rgba(3,101,140,0.9500175070028011) 57%, rgba(2,72,115,1) 92%)",
    },
    springSeason: {
      backgroundImage: "src/img/backEstacoes/spring.jpg",
      backgroundConteudo:
        "linear-gradient(rgb(191, 46, 33) 0%, rgb(242 174 199 / 38%) 75%, rgb(242 206 216 / 0%) 100%), rgb(74 7 7 / 0%)",
      backgroundh1: "#95261d",
    ...
    autumnSeason: {
      ...
      backgroundConteudo:
        "linear-gradient(180deg, rgba(166,72,18,1) 0%, rgba(242,165,22,0.9500175070028011) 71%, rgba(209,124,20,0.3841911764705882) 95%, rgba(209,124,20,0.3841911764705882) 100%)",
      backgroundh1: "#95261d",
      backgroundh2:
        "linear-gradient(180deg, rgba(166,72,18,1) 0%, rgba(242,165,22,0.9500175070028011) 62%, rgba(209,124,20,0.17130602240896353) 100%)",
      backgroundp:
        "linear-gradient(180deg, rgba(182,80,22,0.865983893557423) 0%, rgba(213,146,22,0.9500175070028011) 62%, rgba(209,124,20,0.227328431372549) 100%)",
    },
  };
  ...
  if (season == "padrao") {
    ...
    conteudoBack.style.background =
      "url(src/img/efects/neve.png) center center," + seasons.winterSeason.backgroundConteudo;
    ...
    conteudoBack.style.background =
      "url(src/img/efects/cherry.png) center center," + seasons.springSeason.backgroundConteudo;
    ...
    conteudoBack.style.background =
      "url(src/img/efects/gira.png) left center," + seasons.summerSeason.backgroundConteudo;
    ...
    num = 3;
    conteudoBack.style.background =
      "url(src/img/efects/autum.png) center center," + seasons.autumnSeason.backgroundConteudo;
